            ...
            '<div class="modal-body">'+
                '<p>'+
                    ...
                    '<div class="control-group">'+
                        '<label class="control-label" for="inputLinkText">'+i18n.t('link.text')+'</label>'+
                        '<div class="controls" data-placeholder="link-text">'+
                            
                        '</div>'+
                    '</div>'+
                    '<div class="control-group">'+
                        '<label class="control-label" for="inputLinkValue">'+i18n.t('link.value')+'</label>'+
                        '<div class="controls" data-placeholder="link-value">'+
                        '</div>'+
                    '</div>'+
                '</p>'+
            '</div>'+
...
//                }
            ...
            Aloha.bind('aloha-selection-changed', function(event, rangeObject){
                ...
                if (Aloha.activeEditable && isEnabled[Aloha.activeEditable.getId()]) {
                    ...
                    // selection.
                    $(that._insertLinkButton).removeClass('btn-primary')
                    if (enteredLinkScope && insideLinkScope !== enteredLinkScope) {
                        $(that._insertLinkButton.element).addClass('btn-primary') 
                        //that.hrefField.foreground();
                    }
                }
        ...
        toggleLinkScope: function ( show ) {
            ...
            if ( show ) {
                $(this._insertLinkButton.element).addClass('btn-primary')
                //this.hrefField.show();
                ...
                $(this._insertLinkButton.element).removeClass('btn-primary')
                //this.hrefField.hide();
